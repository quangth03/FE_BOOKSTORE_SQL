...
export default function ProductComment({ book_id }) {
  ...
  return (
    <div>
      {commentRole ? (
        <div style={{ maxWidth: '90%', margin: '20px auto', padding: '20px', border: '1px solid #ccc', borderRadius: '8px' }}>
      ...
      {Array.isArray(reviews) && reviews.length > 0 ? (
        <>
          <div style={{ maxWidth: '90%', margin: '20px auto', paddingLeft: '20px' }}>
          ...
          {reviews.map((item, index) => (
            ...
            >
              ...
              <p style={{color: 'gray', padding: '5px 0px'}}>{moment(item.createdAt).format('DD-MM-YYYY')}</p>
              <div >
                {[1, 2, 3, 4, 5].map((star) => (
                  <span
                    key={star}
        ...
        <p style={{ textAlign: 'center', padding: '20px' }}>Chưa có bình luận nào.</p>
      )}
